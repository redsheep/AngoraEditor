var gameplay = function(game) {
  ...
  this.sceneResFile="gameplay.res"+'?'+ new Date().getTime();
  this.sceneNodeFile="gameplay.scn"+'?'+ new Date().getTime();
  this.worldConfigFile="gameplay.config"+'?'+ new Date().getTime();
